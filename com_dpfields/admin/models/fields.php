...
class DPFieldsModelFields extends JModelList
{
	...
	protected function populateState ($ordering = null, $direction = null)
	{
		...
		$context = $app->getUserStateFromRequest('com_dpfields.fields.filter.context', 'context', 'com_content.article', 'cmd');
	...
	protected function getListQuery ()
	{
		...
		$query->from('#__dpfields_fields AS a');
				...
				if ($cat)
				{
					foreach ($categories as $catId)
					{
						...
						if ($parent)
						{
							...
							while ($parent->getParent()->id != 'root')
							{
