...
<form action="<?php echo JRoute::_('index.php?option=com_dpfields&context=' . $input->getCmd('context', 'com_content') . '&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_DPFIELDS_VIEW_FIELD_FIELDSET_GENERAL', true)); ?>
		<div class="row-fluid">
			<div class="span9">
				<?php
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'publishing', JText::_('COM_DPFIELDS_VIEW_FIELD_FIELDSET_PUBLISHING', true)); ?>
		...
		<?php if ($this->canDo->get('core.admin')) : ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'rules', JText::_('COM_DPFIELDS_VIEW_FIELD_FIELDSET_RULES', true)); ?>
