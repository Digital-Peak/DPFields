...
?>
<form action="<?php echo JRoute::_('index.php?option=com_dpfields&view=fields&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1&context=' . $app->input->get('context'));?>"
		...
		<table class="table table-striped table-condensed">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_DPFIELDS_FIELD_FIELD_TYPE_LABEL', 'a.type', $listDirn, $listOrder); ?>
					</th>
