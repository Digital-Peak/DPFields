...
class DPFieldsViewFields extends JViewLegacy
{
	...
	protected function addToolbar ()
	{
		...
		else if ($lang->hasKey($component_section_key = strtoupper($component . '_FIELDS_SECTION_' . ($section ? $section : ''))))
		{
			...
			$title = JText::sprintf('COM_DPFIELDS_VIEW_FIELDS_TITLE', $this->escape(JText::_($component_section_key)));
		}
		else
		{
			$title = JText::_('COM_DPFIELDS_VIEW_FIELDS_BASE_TITLE');
		}
	...
	protected function getSortFields ()
	{
		return array(
				...
				'a.type' => JText::_('COM_DPFIELDS_FIELD_FIELD_TYPE_LABEL'),
